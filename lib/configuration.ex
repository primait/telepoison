defmodule Telepoison.Configuration do
  ...
  def validate do
    ...
    errors =
      add_if(
        ...
        errors,
        ["The configured :infer_route keyword option value must be a function with an arity of 1" | errors]
      )
  ...
  defp add_if(condition, list, value)
  defp add_if(true, list, value), do: [value | list]
  defp add_if(false, list, _), do: list
end
